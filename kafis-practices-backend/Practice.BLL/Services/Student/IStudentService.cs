...
namespace Practice.Application.Services.StudentN
{
    public interface IStudentService
    {
        ...
        Task<IEnumerable<string>> GetSpecialtiesBySearchParams(RunRequestParams parameters);
        Task<IEnumerable<string>> GetSpecialtiesByDegreeLevel(GradeLevelEnum gradeLevel);
